...
class CreateItemProdutos extends Component {
    constructor(props) {
        super(props);
    ...
    handleButtonSave = () => {
        this.props.createItemProduto(this.state);
...
const mapDispatchToProps = {
    ...
    createItemProduto: itemprodutoActions.createItemProduto,
};
...
export default enhance(CreateItemProdutos);