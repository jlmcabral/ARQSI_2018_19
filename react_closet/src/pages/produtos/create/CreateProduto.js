...
class CreateProduto extends Component {
    ...
    render() {
        ...
        const { nome, categoriaId, dimensaoId, descricao, preco, obrigatorio, produtoId, materialId, restricaoId } = this.state;
    ...
    handleButtonSave = () => {
        this.props.createProduto(this.state);
...
const mapDispatchToProps = {
    ...
    createProduto: produtoActions.createProduto,
};
...
export default enhance(CreateProduto);
